...
switch (global.titlepage)
{
    case PAGE_TITLE:
        ...
        draw_set_color(c_gray);
        draw_text(pos_x, (pos_y + 48), scr_text("title_options"));
        break;
    ...
    case PAGE_OPTIONS:
        // Option texts
        draw_text(pos_x, pos_y, scr_text("options_keys"));
        draw_text(pos_x, (pos_y + 16), scr_text("options_keysdefault"));
        draw_text(pos_x, (pos_y + 32), scr_text("options_clearsave"));
        draw_text(pos_x, (pos_y + 48), scr_text("options_back"));
        break;
    case PAGE_KEYCONFIG:
        // Option key config
